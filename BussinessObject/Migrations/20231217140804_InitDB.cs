...
namespace BussinessObject.Migrations
{
    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
<<<<<<<< HEAD:BussinessObject/Migrations/20240113053451_InitDB.cs
========
                name: "menus",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
>>>>>>>> 0dfa92a9280286804d5ac8d3500958d657ab7d94:BussinessObject/Migrations/20231217140804_InitDB.cs
                name: "users",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_services_users_userId",
========
                    table.PrimaryKey("PK_trackForms", x => x.trackFormId);
                    table.ForeignKey(
