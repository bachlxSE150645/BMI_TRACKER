...
namespace BussinessObject.Migrations
{
    ...
    [Migration("20231103124120_relationshipfix1.5")]
    partial class relationshipfix15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BussinessObject.user", b =>
                {
                    ...
                    b.Property<Guid>("feedbacksfeedbackId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("feedbacksfeedbackId");
            ...
            modelBuilder.Entity("BussinessObject.user", b =>
                {
                    b.HasOne("BussinessObject.feedback", "feedbacks")
                        .WithMany("users")
                        .HasForeignKey("feedbacksfeedbackId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
